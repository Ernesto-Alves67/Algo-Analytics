...
"background-color: rgb(23, 15, 50);"));
        ...
        btn_ajuda = new QPushButton(frame_2);
        btn_ajuda->setObjectName("btn_ajuda");
        btn_ajuda->setEnabled(false);
        btn_ajuda->setMaximumSize(QSize(16777215, 25));
        QFont font;
        font.setPointSize(11);
        btn_ajuda->setFont(font);
        btn_ajuda->setStyleSheet(QString::fromUtf8("background-color: rgb(50, 50, 50);\n"
"color: rgb(255, 255, 255);"));

        horizontalLayout_7->addWidget(btn_ajuda);

        btn_estrCriadas = new QPushButton(frame_2);
        btn_estrCriadas->setObjectName("btn_estrCriadas");
        btn_estrCriadas->setMinimumSize(QSize(0, 0));
        btn_estrCriadas->setMaximumSize(QSize(16777215, 25));
        btn_estrCriadas->setFont(font);
        btn_estrCriadas->setStyleSheet(QString::fromUtf8("background-color: rgb(50, 50, 50);\n"
"color: rgb(255, 255, 255);"));

        horizontalLayout_7->addWidget(btn_estrCriadas);
...
"background-color: rgb(57, 64, 127);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_ajuda->setText(QCoreApplication::translate("MainWindow", "Ajuda", nullptr));
        btn_estrCriadas->setText(QCoreApplication::translate("MainWindow", "Estruturas Criadas", nullptr));
